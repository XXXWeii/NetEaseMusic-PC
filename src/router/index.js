...
const routes = [
  ...
  },
  {
    ...
    name: "playlistdetail",
    component: resolve => {
      require(["@views/playlist/detail.vue"], resolve);
    }
  },
  {
    path: "/song",
    name: "songs",
    component: resolve => {
      require(["@views/songs/index.vue"], resolve);
    }
  },
  {
    path: "/singer",
  ...
  },
  {
    ...
    name: "mv",
    component: resolve => {
      require(["@views/mv/detail.vue"], resolve);
    }
  },
  {
    path: "/my",
    name: "my",
    children: [
      { path: "/my/favorite", name: "myFavorite", component: Favorite },
      { path: "/my/playlist", name: "myPlaylist", component: Playlist }
    ],
    component: resolve => {
  ...
  },
  {
    ...
    name: "artist",
    component: resolve => {
      require(["@views/artist/index.vue"], resolve);
    }
  },
  {
    path: "/search",
  ...
  },
  {
    ...
    name: "video",
    component: resolve => {
      require(["@views/video/detail.vue"], resolve);
    }
  },
  {
    path: "/user",
